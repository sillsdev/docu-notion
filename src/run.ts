  ...
  program
    ...
    .addOption(
      new Option(
        ...
        "format:\n- default: {page slug (if any)}.{original file name (if it can be determined)}.{image block ID}\n- content-hash: Use a hash of the image content.\n- legacy: Use the legacy (<= v15) method of determining file names. Set this to maintain backward compatibility.\nAll formats will use the original file extension."
      )
