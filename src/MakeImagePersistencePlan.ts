...
export function makeImagePersistencePlan(
  ...
  if (options.imageFileNameFormat === "legacy") {
    ...
    // as feasible for our localization workflow. However, for someone not concerned with localization,
    // this is a good option. For one thing, it means the image only needs to exist once in the output.
